  ...
  class FastClimbEvent {
    ...
    class DisabledSetting {
      ...
      void doesNotConstructFastClimb() {
        ...
        Feature.forceDisable(Feature.MOBILITY.FAST_CLIMB);
    ...
    class DisabledPlayerSetting {
      ...
      void doesNotConstructFastClimb() {
        ...
        ClientConfig.setEnabled(Feature.MOBILITY.FAST_CLIMB, true);
        PlayerPreference.setEnabled(Feature.MOBILITY.FAST_CLIMB, player.serverPlayer(), false);
